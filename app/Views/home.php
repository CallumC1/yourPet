...
<div class="relative w-full max-h-96">
    <img src="/assets/images/cow-hero.jpg" alt="" class="w-full h-96 object-cover opacity-95">
...
<div class="flex flex-col w-full">
    ...
    <div class="mt-8 flex mx-auto max-w-screen-2xl">
    
        <div class="grid grid-cols-3 gap-8 mt-8">
            <div class="flex flex-col items-center">
                <img src="/assets/icons/HealthCross.svg" alt="" class="w-20 h-20">
    ...
    <div class="mt-20  mx-auto max-w-screen-2xl">
